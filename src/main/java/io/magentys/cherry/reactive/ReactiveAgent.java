 ...
 */
@SuppressWarnings({"WeakerAccess", "unchecked", "OptionalGetWithoutIsPresent", "unused"})
public class ReactiveAgent extends FunctionalAgent
{
  ...
  public <RESULT> Either<RESULT, Failure> performsReactively(ReactiveMission<RESULT> reactiveMission)
  {
    ...
    try
    {
      ...
      if (!Objects.equals(strategySet, "setStrategyCompleted")) throw new StrategyException("not properly set");
